...
const people = [
    {
        ...
        bio:
          'Olivia is an MPhil student in Management at the Judge Business School of Cambridge University. Olivia graduated from Oxford in 2020 with a First Class Degree in Geography. She recently completed a competitive internship at a leading Private Markets firm in Switzerland.',
        twitterUrl: '#',
        linkedinUrl: '#',
      },
      {
        ...
        bio:
          'Tamzin is an English Literature Scholar at the University of Oxford, and Ex-Treasurer of the Oxford Union with experience raising money for some of the largest student societies. She is currently Events Director for OXVC and has experience working in various start-ups.',
        twitterUrl: '#',
        linkedinUrl: '#',
      },
      {
